It implements a simple Food Ordering System using the Swing library to create a graphical user interface (GUI). The application is structured with two main panels: a Menu Panel and 
